# CSV Publications Generator for Academic Pages
# This script generates Jekyll markdown files from a CSV spreadsheet
...
def generate_publications_from_csv():
    """Generate publication markdown files from CSV."""
    
    # Read the CSV file
    try:
        publications = pd.read_csv("publications.csv")
        print(f"Loaded {len(publications)} publications from CSV file")
    except FileNotFoundError:
        print("Error: publications.csv not found!")
        print("Please create publications.csv with your publication data")
        return
...
if __name__ == "__main__":
    print("CSV Publications Generator")
    print("=========================")
    generate_publications_from_csv()
